...
export const Product: FC<{ item: any }> = ({ item }) => {
    // console.log(item, "raza");
    const handlerCart = async (params: any) => {

        console.log("coll this",item._id);
    ...
    return (
        <>
            ...
            <div className="w-full max-w-sm bg-white py-4 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-5" style={{ backgroundColor: "#FFEDD5" }}>
                <a href="#" >
                    <Image width={390} height={0} src={urlForImage(item.Image).url()} className="rounded-t-lg max-h-[200px] object-cover object-top" alt='product' />
                ...
                <div className="p-8 ">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <a onClick={()=>handlerCart(item)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" style={{ backgroundColor: "#AA9271" }}>Add to cart</a>
                    </div>
                </div>
            </div>
